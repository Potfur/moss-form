...
class MailTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $field = new Mail('name', 'value', array('id' => $actual));
    ...
    {
        $field = new Mail('name', 'value', array('label' => $actual));
    ...
    {
        $field = new Mail($actual, 'value', array());
    ...
    {
        $field = new Mail(null, 'value', array());
    ...
    {
        $field = new Mail('name', $actual, array());
    ...
    {
        $field = new Mail('name', null, array());
    ...
    {
        $field = new Mail('name', 'value', array('required' => true));
    ...
    {
        $field = new Mail('name', 'value', array('required'));
    ...
    {
        $field = new Mail('name', 'value', array('required'));
        $this->assertEquals('<input type="email" id="name" name="name" value="value" required="required"/>', $field->renderField());
    }
    ...
    {
        $field = new Mail('name', 'value', array('id' => 'id', 'label' => 'label', 'required', 'class' => array('foo')));
        $this->assertEquals('<label for="id">label<sup>*</sup></label><input type="email" id="id" name="name" value="value" required="required" class="foo"/>', $field->render());
    }
