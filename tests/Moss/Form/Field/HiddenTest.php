...
class HiddenTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $field = new Hidden('name', 'value', array('id' => $actual));
    ...
    {
        $field = new Hidden('name', 'value', array());
    ...
    {
        $field = new Hidden('name', 'value', array('label' => $actual));
    ...
    {
        $field = new Hidden($actual, 'value', array());
    ...
    {
        $field = new Hidden(null, 'value', array());
    ...
    {
        $field = new Hidden('name', $actual, array());
    ...
    {
        $field = new Hidden('name', null, array());
    ...
    {
        $field = new Hidden('name', 'value', array('required' => true));
    ...
    {
        $field = new Hidden('name', 'value', array('required'));
        $this->assertEquals('', $field->renderLabel());
    }

    public function testRenderField()
    {
        $field = new Hidden('name', 'value', array('required'));
        $this->assertEquals('<input type="hidden" id="name" name="name" value="value" required="required"/>', $field->renderField());
    }
    ...
    {
        $field = new Hidden('name', 'value', array('id' => 'id', 'label' => 'label', 'required', 'class' => array('foo')));
        $this->assertEquals('<input type="hidden" id="id" name="name" value="value" required="required" class="foo"/>', $field->render());
    }
