...
class PasswordTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $field = new Password('name', 'value', array('id' => $actual));
    ...
    {
        $field = new Password('name', 'value', array());
    ...
    {
        $field = new Password('name', 'value', array('label' => $actual));
    ...
    {
        $field = new Password($actual, 'value', array());
    ...
    {
        $field = new Password(null, 'value', array());
    ...
    {
        $field = new Password('name', $actual, array());
    ...
    {
        $field = new Password('name', null, array());
    ...
    {
        $field = new Password('name', 'value', array('required' => true));
    ...
    {
        $field = new Password('name', 'value', array('required'));
    ...
    {
        $field = new Password('name', 'value', array('required'));
        $this->assertEquals('<input type="password" id="name" name="name" value="value" required="required"/>', $field->renderField());
    }
    ...
    {
        $field = new Password('name', 'value', array('id' => 'id', 'label' => 'label', 'required', 'class' => array('foo')));
        $this->assertEquals('<label for="id">label<sup>*</sup></label><input type="password" id="id" name="name" value="value" required="required" class="foo"/>', $field->render());
    }
