...
class TextTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $field = new Text('name', 'value', array('label' => $actual));
    ...
    {
        $field = new Text($actual, 'value', array());
    ...
    {
        $field = new Text(null, 'value', array());
    ...
    {
        $field = new Text('name', $actual, array());
    ...
    {
        $field = new Text('name', null, array());
    ...
    {
        $field = new Text('name', 'value', array('required' => true));
    ...
    {
        $field = new Text('name', 'value', array('required'));
    ...
    {
        $field = new Text('name', 'value', array('required'));
        $this->assertEquals('<input type="text" id="name" name="name" value="value" required="required"/>', $field->renderField());
    }
    ...
    {
        $field = new Text('name', 'value', array('id' => 'id', 'label' => 'label', 'required', 'class' => array('foo')));
        $this->assertEquals('<label for="id">label<sup>*</sup></label><input type="text" id="id" name="name" value="value" required="required" class="foo"/>', $field->render());
    }
