...
class UrlTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $field = new Url('name', 'value', array('id' => $actual));
    ...
    {
        $field = new Url('name', 'value', array());
    ...
    {
        $field = new Url('name', 'value', array('label' => $actual));
    ...
    {
        $field = new Url($actual, 'value', array());
    ...
    {
        $field = new Url(null, 'value', array());
    ...
    {
        $field = new Url('name', $actual, array());
    ...
    {
        $field = new Url('name', 'value', array('required' => true));
    ...
    {
        $field = new Url('name', 'value', array('required'));
    ...
    {
        $field = new Url('name', 'value', array('required'));
        $this->assertEquals('<input type="url" id="name" name="name" value="value" required="required"/>', $field->renderField());
    }
    ...
    {
        $field = new Url('name', 'value', array('id' => 'id', 'label' => 'label', 'required', 'class' => array('foo')));
        $this->assertEquals('<label for="id">label<sup>*</sup></label><input type="url" id="id" name="name" value="value" required="required" class="foo"/>', $field->render());
    }
