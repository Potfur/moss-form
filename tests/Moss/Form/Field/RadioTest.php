...
<li class="options"><input type="radio" name="name" value="option_1" id="name_option_1" /><label for="name_option_1" class="inline">Option 1</label></li>
<li class="options"><input type="radio" name="name" value="option_2" id="name_option_2" /><label for="name_option_2" class="inline">Option 2</label></li>
</ul>';
